...
class AccountInvoiceByState(models.AbstractModel):
...
class AccountInvoiceByStatePurchase(models.AbstractModel):
...
class AccountInvoiceByStateSale(models.AbstractModel):
