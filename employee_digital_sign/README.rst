...
When a receipt is signed, a signature is automatically generated from the user's name.

You can also configure where the receipt will be signed in the sign configuration tab
