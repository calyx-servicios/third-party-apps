odoo.define('pos_all_in_one.pos', function(require) {
	...
	var PaymentReceiptWidget = screens.ScreenWidget.extend({
		...
		payment_render_reciept: function(){
			this.$('.pos-payment-receipt').html(QWeb.render('XMLPosPaymentSummaryReceipt', this.get_payment_receipt_render_env()));
		},
		
		print_xml_payment: function() {
			var receipt = QWeb.render('XMLPosPaymentSummaryReceipt', this.get_order_receipt_render_env());
	...
	var OrderReceiptWidget = screens.ScreenWidget.extend({
		...
		order_render_reciept: function(){
			this.$('.order-receipt').html(QWeb.render('XMLPosOrderSummaryReceipt', this.get_order_receipt_render_env()));
		},
	...
	var ProductReceiptWidget = screens.ScreenWidget.extend({
		...
		product_render_reciept: function(){
			this.$('.pos-product-receipt').html(QWeb.render('XMLPosProductSummaryReceipt', this.get_product_receipt_render_env()));
		},
	...
	var CategoryReceiptWidget = screens.ScreenWidget.extend({
		...
		category_render_reciept: function(){
			this.$('.pos-category-receipt').html(QWeb.render('XMLPosCategorySummaryReceipt', this.get_category_receipt_render_env()));
		},
	...
	var LocationReceiptWidget = screens.ScreenWidget.extend({
		...
		location_render_reciept: function(){
			this.$('.location-receipt').html(QWeb.render('LLocationSummaryReceipt', this.get_location_receipt_render_env()));
		},
