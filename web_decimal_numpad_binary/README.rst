==========================================
Binary - Numpad Dot as decimal separator
==========================================

.. !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! This module was created to be able to add      !!
   !! relevant data for the management of contact    !! 
   !! information                                    !!
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
# Go to applications
# Find module web decimal numpad binary
# Press Install
