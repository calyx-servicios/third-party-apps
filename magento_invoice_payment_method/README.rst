==============================
Magento Invoice Payment Method
==============================
...
This module add referential field for Magento Payment Method into invoice.
...
Go to Odoo Apps, install magento_invoice_payment_method module
